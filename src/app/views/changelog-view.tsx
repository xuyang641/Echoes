...
const releases: Release[] = [
  // Apr 13
  {
    ...
    changesKey: 'changelog.features.v4.5.0'
  },
  // Apr 12
  {
    version: 'v4.4.0',
    date: '2026-04-12',
    titleKey: '体验优化与 AI 增强',
    icon: Sparkles,
    color: 'bg-yellow-100 text-yellow-700',
    changesKey: 'changelog.features.v4.4.0'
  },
  // Apr 11
  {
    version: 'v4.3.0',
    ...
    changesKey: 'changelog.features.v4.3.0'
  },
  // Mar 23
  {
    version: 'v4.2.0',
...
export function ChangelogView() {
  ...
  const getChanges = (version: string) => {
    ...
    if (version === 'v4.3.0') return [
      '品牌视觉升级: 将顶部导航栏与侧边栏的 Echoes 标题和副标题替换为手写艺术字体 (Dancing Script)，更具温度感',
      '文案优化: 将 Slogan 更新为 "capture your life moments"，更贴合产品理念',
      '富文本编辑器增强: 在「记一笔」页面新增了文本颜色拾色器，您可以为选中的文字自由设置个性化颜色',
      '依赖升级: 引入 @tiptap/extension-color 与 text-style 扩展，完善编辑器功能'
    ];
