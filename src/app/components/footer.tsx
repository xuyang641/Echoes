...
export function Footer() {
  ...
  return (
    <footer className="hidden md:block bg-white/80 dark:bg-[#111111]/80 backdrop-blur-md border-t border-gray-200/50 dark:border-gray-700/50 py-4 mt-auto transition-colors w-full z-20 rounded-xl mb-4 shadow-sm">
