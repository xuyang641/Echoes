...
const resources = {
  en: {
    translation: {
      ...
      account: {
        ...
        photos: 'PHOTOS',
        places: 'PLACES',
        copyId: 'Copy My User ID',
        sponsorTip: '* Tip: Paste your User ID in the donation remark to get automatic Pro upgrade.',
        idCopied: 'User ID Copied! Please paste it in the "Remark/留言" field on Afdian so we can upgrade your account automatically.',
        version: 'Version',
        madeWith: 'Made with ❤️ by Echoes Team',
        sponsor: 'Sponsor Developer',
        sponsor_desc: 'If you like Echoes, consider buying me a coffee to support development and server costs.',
        donate_afdian: 'Sponsor on Afdian'
      },
      appearance: {
        title: 'Appearance',
        dark_mode: 'Dark Mode',
        light_mode: 'Light Mode',
        theme_desc: 'Adjust the interface brightness',
        font_size: 'Font Size',
        accent_color: 'Accent Color',
        immersive_bg: 'Immersive Background',
        bg_none: 'None',
        bg_rain: 'Rainy Day',
        bg_forest: 'Forest',
        font_style: 'Font Style',
        font_sans: 'System Sans',
        font_serif: 'Serif',
        font_lxgw: 'LXGW WenKai',
        font_mashanzheng: 'Ma Shan Zheng',
        font_zcool: 'ZCOOL KuaiLe',
        colors: {
          default: 'Default',
          mint: 'Mint',
          sakura: 'Sakura',
      ...
      dream: {
        open: 'AI Dream Painter',
        title: 'Dream Painter',
        close: 'Close',
        placeholder: 'Describe the scene (e.g. A cat sleeping on a cloud)',
        placeholder_diary: 'Using diary content...',
        tip: '* AI works best with English. Keywords are auto-appended.',
  ...
  zh: {
    translation: {
      ...
      account: {
        ...
        activeDays: '活跃天数',
        totalWords: '总字数',
        momentsCaptured: '记录瞬间',
        locationsVisited: '足迹点',
        days: '天',
        words: '字',
        photos: '张',
        places: '个',
        copyId: '复制我的 ID',
        sponsorTip: '* 提示：请在捐赠备注中粘贴您的 ID 以自动升级 Pro。',
        idCopied: 'ID 已复制！请粘贴在爱发电的留言区。',
        version: '版本',
        madeWith: 'Echoes 团队用心打造',
        sponsor: '赞助开发者',
        sponsor_desc: '如果你喜欢 Echoes，可以请我喝杯咖啡，支持开发和服务器成本。',
        donate_afdian: '在爱发电赞助'
      },
      security: {
        title: '隐私与安全',
        biometric: '生物识别锁',
        biometric_desc: '启动应用时需要指纹/面容验证',
        privacy_screen: '隐私防窥',
        privacy_desc: '在多任务切换时模糊应用内容',
        biometric_enabled: '已开启生物识别锁',
        biometric_disabled: '已关闭生物识别锁',
        authAvailable: '该设备不支持生物识别',
        authFailed: '验证失败',
        privacyEnabled: '隐私防窥已开启。应用内容将在多任务视图中隐藏。',
        privacyDisabled: '隐私防窥已关闭。',
        verifyReason: '启用生物识别锁',
        verifyTitle: '身份验证',
        verifySubtitle: '请验证您的身份',
        verifyDesc: '使用面容或指纹'
      },
      appearance: {
        title: '外观设置',
      ...
      dream: {
        ...
        title: '梦境画师',
        close: '关闭',
        placeholder: '描述你想要的画面 (例如：云端睡觉的猫)...',
        placeholder_diary: '正在使用日记内容...',
        tip: '* 建议使用英文描述以获得最佳效果。会自动追加关键词。',
        generate: '生成画作',
        generating: '绘制中...',
        generated: '已生成',
        error: '生成失败'
      ...
      storage: {
        ...
        resetFailed: '重置失败',
        dangerZone: '危险区域',
        dangerDesc: '这将永久删除您的所有日记、照片和设置。此操作无法撤销。\n\n请确保您已备份。',
        deleteEverything: '删除所有数据'
      },
      notifications: {
        title: '每日提醒',
        desc: '接收温馨提醒，记录美好回忆。',
        ...
        off: '已关闭',
        reminderTitle: '该写日记了',
        reminderBody: '今天过得怎么样？记录下此刻的心情吧。',
        scheduled: '已设置每日 {{time}} 提醒',
        cancelled: '提醒已取消',
        permissionDenied: '通知权限被拒绝'
      },
      backup: {
        title: '备份与恢复',
        desc: '导出所有回忆（含照片）为 ZIP 文件。请妥善保管。',
        export: '导出备份',
        exporting: '正在导出...',
        confirmExport: '确定要导出所有数据吗？这可能需要一些时间。',
        confirmRestore: '这将合并备份数据到当前数据中。继续吗？',
        restoring: '正在恢复...',
        restoreSuccess: '恢复完成！即将刷新页面...',
        restoreFailed: '恢复失败，请检查备份文件是否损坏。',
        preparing: '准备中...',
        restoreComingSoon: '恢复功能即将上线！',
        success: '备份已保存到 Downloads 目录',
        downloaded: '备份已下载！'
      },
      subscription: {
        title: '升级你的回忆',
        ...
        features: {
          ...
          export: '标准画质导出',
          ads: '含广告',
          unlimited: '无限照片存储与云备份',
          ai: '每日 100 次 AI 绘画与智能分析',
          quality: '4K 无损导出与矢量 PDF',
          support: '优先客服与技术支持',
          noAds: '无广告沉浸体验',
          lifetime: '终身免费更新所有新功能',
          badge: '专属“创始人”徽章与头像框',
          beta: '抢先体验新功能 (如: 3D 打印)',
          vip: '冲印店全场 8 折优惠',
          themes: '解锁所有 3D 沉浸式主题',
          starter: {
            storage: '仅限本地存储 (无云备份)',
            sync: '不支持多端同步',
            ai: '不支持 AI 分析与绘图',
  ...
  ja: {
    translation: {
      ...
      filters: {
        ...
        subscription: {
          title: 'プランのアップグレード',
          subtitle: 'あなたの物語に最適なプランをお選びください。いつでもキャンセル可能です。',
          monthly: '月額',
          yearly: '年額',
          save: '20% OFF',
          mostPopular: '一番人気',
          ...
          features: {
            photos: '毎月の写真制限',
            filters: '基本的なフィルターと編集',
            export: '標準画質のエクスポート',
            ads: '広告あり',
            unlimited: '無制限の写真ストレージとクラウドバックアップ',
            ai: '毎日100回のAI描画とスマート分析',
            quality: '4KロスレスエクスポートとベクターPDF',
            support: '優先カスタマーサポート',
            noAds: '広告なしの没入体験',
            lifetime: 'すべての新機能を永久に無料で更新',
            badge: '専用の「創設者」バッジとアバターフレーム',
            beta: '新機能への早期アクセス（例：3Dプリント）',
            vip: 'プリントショップ全品20%オフ',
            themes: 'すべての3D没入型テーマをロック解除',
            starter: {
              storage: 'ローカルストレージのみ (クラウドなし)',
              sync: 'クラウド同期なし',
              ai: 'AI機能なし',
              theme: 'デフォルトテーマのみ'
            }
          ...
          payment: {
            ...
            scanTip: 'アプリでスキャン',
            uploadTip: 'ヒント: プライバシー保護のため、クリエイタープラットフォーム（Buy Me a Coffeeなど）の使用をお勧めします。',
            openLink: 'または支払いリンクを開く'
          }
        },
      changelog: {
        title: '更新履歴',
  ...
  ko: {
    translation: {
      ...
      subscription: {
        title: '추억 업그레이드',
        subtitle: '당신의 여정에 맞는 요금제를 선택하세요. 언제든지 취소 가능합니다.',
        monthly: '월간',
        yearly: '연간',
        save: '20% 절약',
        mostPopular: '인기',
        ...
        features: {
          ...
          export: '표준 품질 내보내기',
          ads: '광고 포함',
          unlimited: '무제한 사진 저장소 및 클라우드 백업',
          ai: '매일 100회 AI 드로잉 및 스마트 분석',
          quality: '4K 무손실 내보내기 및 벡터 PDF',
          support: '우선 고객 지원',
          noAds: '광고 없는 몰입형 경험',
          lifetime: '모든 새로운 기능 평생 무료 업데이트',
          badge: '독점 "설립자" 배지 및 아바타 프레임',
          beta: '새로운 기능 미리 체험 (예: 3D 프린팅)',
          vip: '인화소 전 품목 20% 할인',
          themes: '모든 3D 몰입형 테마 잠금 해제',
          starter: {
            storage: '로컬 저장소만 (클라우드 없음)',
            sync: '클라우드 동기화 없음',
            ai: 'AI 기능 없음',
            theme: '기본 테마만'
          }
